...
import com.dsss.ankush.shlokaabhyasanupdated.SubCategoryType;

public class SubCategoryAdapter extends BaseAdapter {
    ArrayList<String> names;
    ArrayList<SubCategoryType> data;
    Context c;
    SubCategoryAdapter(Context c, ArrayList<String> names,ArrayList<SubCategoryType> data )
    {
        this.names=names;
        this.data=data;
        this.c=c;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent ii=new Intent(c,HymnsActivity.class);
                ii.putExtra("sub",data.get(i).hymn);
